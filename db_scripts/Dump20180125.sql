...
INSERT INTO `consultorios` VALUES (1,1,'OFI_1_C1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,1,'OFI_1_C2','0000-00-00 00:00:00','0000-00-00 00:00:00'),(3,1,'OFI_1_C3','0000-00-00 00:00:00','0000-00-00 00:00:00'),(4,2,'OFI_2_C1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(5,2,'OFI_2_C2','0000-00-00 00:00:00','0000-00-00 00:00:00'),(6,1,'otro consultorio de of1','2017-12-26 20:28:22','2017-12-26 20:28:22'),(7,13,'Consultorio 1','2018-01-23 17:53:36','2018-01-23 17:53:36'),(8,12,'Consultorio 2','2018-01-23 17:53:42','2018-01-23 17:53:42');
...
CREATE TABLE `domicilios` (
  ...
  UNIQUE KEY `domicilioscol_UNIQUE` (`id_paciente`),
  UNIQUE KEY `oficina_id_UNIQUE` (`id_oficina`),
  CONSTRAINT `domicilio_oficina` FOREIGN KEY (`id_oficina`) REFERENCES `oficinas` (`id_oficina`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `domicilio_paciente` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_paciente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `domicilios` VALUES (22,'Calle Quince','1000','DISTRITO','BARRIO','2018-01-19 20:39:12','2018-01-25 02:57:56',12,NULL),(23,'RIVADAVIA','230','DISTRITO','LANUS','2018-01-23 17:45:22','2018-01-23 17:45:22',NULL,NULL),(24,'RIVADAVIA','230','DISTRITO','LANUS','2018-01-23 17:45:46','2018-01-23 17:45:46',14,NULL),(26,NULL,NULL,NULL,'BARRIO','2018-01-25 03:19:51','2018-01-25 03:19:51',NULL,NULL),(27,NULL,NULL,NULL,'BARRIO','2018-01-25 03:34:32','2018-01-25 03:34:32',NULL,NULL),(28,NULL,NULL,NULL,'BARRIO','2018-01-25 03:47:10','2018-01-25 03:47:10',NULL,NULL),(29,NULL,NULL,NULL,'BARRIO','2018-01-25 03:47:42','2018-01-25 03:47:42',NULL,14);
...
INSERT INTO `especialidades` VALUES (1,'ESP_1','0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,'ESP_2','0000-00-00 00:00:00','0000-00-00 00:00:00'),(3,'Especialidad 3','2017-12-21 04:14:12','2017-12-21 04:14:12'),(4,'Pediatría','2018-01-23 17:44:27','2018-01-23 17:44:27');
...
INSERT INTO `especialistas` VALUES (1,'especialista 1','apellido',NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(2,'especialista 2','apellido',NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00'),(3,'nombre especialista','apellido esp','1234578','2017-12-22 19:29:09','2017-12-22 19:29:09'),(4,'otro esp','otro apellido','123567','2017-12-22 19:29:43','2017-12-22 19:29:43'),(5,'Cristian','Lopreiato','12123234','2018-01-23 17:42:10','2018-01-23 17:42:10');
...
INSERT INTO `horarios_atencion` VALUES (1,5,13,'09:00:00','18:00:00',1,'00:30:00',4,'2018-01-23 17:49:45','2018-01-23 17:49:45'),(2,5,13,'10:00:00','14:00:00',2,'00:30:00',4,'2018-01-25 01:17:59','2018-01-25 01:17:59');
...
CREATE TABLE `oficinas` (
  ...
  CONSTRAINT `oficina_domicilio` FOREIGN KEY (`id_domicilio`) REFERENCES `domicilios` (`id_domicilio`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `oficinas` VALUES (12,22,'Hospital Pequeño','2018-01-19 20:39:12','2018-01-19 20:39:12'),(13,23,'Gran Hospital','2018-01-23 17:45:22','2018-01-23 17:45:22'),(14,24,'Otro Gran Hospital','2018-01-23 17:45:46','2018-01-23 17:45:46');
...
INSERT INTO `turnos` VALUES (7,1,1,1,'2017-12-11 13:40:00','2017-12-11 14:00:00',1,'0000-00-00 00:00:00','0000-00-00 00:00:00');
...
-- Dump completed on 2018-01-25 19:29:21

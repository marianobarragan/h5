...
<div class="col-lg-6 col-md-offset-2">
	...
	<form role="form" method="POST" action="/horarios">
		{{ csrf_field() }}
        ...
        <div class="form-group" style="padding-bottom: 8px">
            ...
            <div class="col-sm-8">
                <input class="form-control" placeholder="Ingrese la duración de los turnos con formato HH:SS" name="duracion_turnos">
            </div>
        </div>                
        <hr>        

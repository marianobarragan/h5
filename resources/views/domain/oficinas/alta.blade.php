...
<div class="col-lg-6 col-md-offset-2">
	@section ('panel2_panel_title', 'Alta Oficinas')
	@section ('panel2_panel_body')
	<form role="form" method="POST" action="/oficinas">
		{{ csrf_field() }}
		<label style="padding-bottom:10px">Ingrese una descripción de la oficina:</label>
		
		<div class ="form-group" style="padding-bottom:40px">
			<div class="form-group col-lg-12">   
	            <input class="form-control" placeholder="Ingrese la descripción" name="descripcion" id="descripcion">
	        </div>
		</div>
